    ...
    <main className="dashboard-main reference-dashboard">
      <section className="reference-welcome">
        <div>
          ...
          <p>
            Real-time monitoring â€¢ AI-powered risk assessment â€¢ Early
            warnings â€¢ Safer North-East India
          </p>
        </div>

        <button type="button" className="zone-selector">
          <span className="zone-selector-icon">â—‰</span>
          <span>{dashboard?.risk_zone?.name || "Monitoring Zone"}</span>
          <span className="zone-selector-arrow">âŒ„</span>
        </button>
      </section>
      ...
      <section className="reference-kpi-grid">
        <article className="reference-kpi monitoring-kpi">
          ...
          <div className="kpi-content">
            ...
            <strong>1</strong>
            <small className="kpi-positive">â†‘ 0 this week</small>
          </div>
          <span className="kpi-action">â–£</span>
        </article>
        ...
        <article className="reference-kpi sensor-kpi">
          ...
          <div className="kpi-content">
            ...
            <small className="kpi-positive">
              â†‘ {activeSensorCount > 0 ? 1 : 0} this week
            </small>
          </div>
          <span className="kpi-action">â†—</span>
        </article>
        ...
        <article className="reference-kpi alert-kpi">
          ...
          <div className="kpi-content">
            ...
            <small className="kpi-positive">
              â†‘ {dashboard.active_alert_count ?? 0} this week
            </small>
          </div>
          <span className="kpi-action">â™§</span>
        </article>
      ...
      <section className="reference-primary-grid">
          ...
          <div className="reference-alert-list">
            {alerts.length === 0 ? (
              <div className="reference-no-alerts">
                <div className="no-alert-icon">âœ“</div>
        ...
        <article className="reference-panel reference-weather-panel">
          ...
          <div className="weather-location">
            ...
            <span>
              {dashboard?.risk_zone?.latitude ?? "N/A"}Â° N,{" "}
              {dashboard?.risk_zone?.longitude ?? "N/A"}Â° E
            </span>
          </div>
